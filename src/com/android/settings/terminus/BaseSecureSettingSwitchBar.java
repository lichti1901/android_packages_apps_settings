...
public class BaseSecureSettingSwitchBar implements SwitchBar.OnSwitchChangeListener  {
    ...
    public BaseSecureSettingSwitchBar(Context context, SwitchBar switchBar, String key,
